...
<title>Delta Terminal</title>  <style>  
...
</nav>  <section id="markets">  
 <div class="market-grid">    <div class="market-card">  
...
</section>  <div class="desktop-layout">  
<div>  <section class="section" id="signals">  
 ...
 </div>   <div class="signal-grid">    <div class="signal-card">  
...
</section>  <section class="section" id="smc">  
 <div class="section-head">  
 ...
 </div>   <div class="smc-grid">    <div class="smc-card">  
   <div class="smc-top">  
...
</section>  <section class="section" id="logs">  
...
</section>  </div>  <aside class="side-panel">  
